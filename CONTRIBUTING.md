...
[randomshuffle Gitter channel](https://gitter.im/ZenyWay/randomshuffle).

## <a name="issues"></a> Issues
### Security issues
For the security of the community relying on randomshuffle,
...
are tracked as GitHub [issues in this repository](https://github.com/ZenyWay/randomshuffle/issues):
* please either [submit a new issue](https://github.com/ZenyWay/randomshuffle/issues/new)
...
**randomshuffle version:** (only for issues) first version of randomshuffle affected by the issue
...
* a PR must close at least one [open issue](https://github.com/ZenyWay/randomshuffleg/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen).
The corresponding issues should be listed in the title of the PR,
e.g. "close #21, #42".
* all PRs must pass the full randomshuffle test suite and
...
https://github.com/ZenyWay/randomshuffle/blob/master/ICLA.
```
This is required both in the contributor's own interest,
and that of the community relying on this project,
...
#### CI
CI testing runs on [TravisCI](https://travis-ci.org/ZenyWay/randomshuffle).
